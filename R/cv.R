...
#' \item{subsets}{an integer matrix in which each column contains a permutation
#' of the indices of the observations or groups.}
#' \item{which}{an integer vector giving the fold for each permuted observation
#' or group.}
#' \item{grouping}{a list giving the indices of the observations belonging to
#' each group.  This is only returned if a grouping factor has been supplied.}
#'
#' @author Andreas Alfons
#'
