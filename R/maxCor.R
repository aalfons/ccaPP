...
#' standardization of \code{y}.}
#' \item{lambdaX}{a numeric giving the optimal penalty parameter for the
#' weighting vector of \code{x} (only \code{sMaxCorGrid}).}
#' \item{lambdaY}{a numeric giving the optimal penalty parameter for the
#' weighting vector of \code{y} (only \code{sMaxCorGrid}).}
#' \item{objective}{a numeric giving the value of the objective function
#' for the optimal combination of penalty parameters (only \code{sMaxCorGrid}).}
#' \item{cv}{a numeric matrix containing the (average) results from
